...
data_folder = "Data"
available_files = [f for f in os.listdir(data_folder) if f.endswith(".xlsx")]
    ...
    if apply_filter_btn and selected_subcategories:
        ...
        if filtered_df.empty:
            ...
            def color_scale(val):
                ...
                return f'background-color: {background_color}; color: {font_color}; font-weight: bold;font-size: 20px;'
